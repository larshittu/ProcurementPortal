  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#8307a5', '#172f71', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#ecb403', '#64E572' ,'#24CBE5', '#8307a5', '#172f71' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#ecb403', '#24CBE5', '#172f71' , '#8307a5', '#ff5c75' ],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	colors: ['#8307a5', '#172f71', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
